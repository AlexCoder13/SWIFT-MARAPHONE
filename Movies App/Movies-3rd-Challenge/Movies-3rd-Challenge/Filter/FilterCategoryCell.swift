...
//            // Если ячейка содержит текст "Others", делаем пунктирную границу
//            if titleLabel.text == "Others" {
//                let shapeLayer = CAShapeLayer()
//                shapeLayer.strokeColor = UIColor.systemBlue.cgColor
//                shapeLayer.lineWidth = 1
//                shapeLayer.lineDashPattern = [4, 4] // Шаблон пунктирной линии: 4 пикселя линия, 4 пикселя пробел
//                
//                let path = UIBezierPath(rect: contentView.bounds.insetBy(dx: 0.5, dy: 0.5))
